...
$req_courses = "SELECT courses_id, point_depart, point_darrivee, date_heure
                FROM courses
...
$req_chauffeurs = "SELECT chauffeur_id, nom, prenom, telephone
...
<head>
    ...
    <title>RAPIDO - Affecter un Chauffe<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
    ...
    <div class="container mt-5 pt-5">
        ...
        <form action="traitement_chauffeur.php" method="post">
            <div class="mb-3">
                ...
                <select class="form-select" name="courses_id" required>
                    ...
                    <option value="<?php echo $course['courses_id']; ?>">
                        <?php echo htmlspecialchars($course['point_depart']); ?>
                        vers <?php echo htmlspecialchars($course['point_darrivee']); ?>
                        - <?php echo htmlspecialchars($course['date_heure']); ?>
                    </option>
                    <?php endwhile; ?>
                </select>
            </div>
        ...
        <?php else: ?>
            <?php if (mysqli_num_rows($res_courses) == 0): ?>
