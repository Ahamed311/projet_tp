    ...
    <div class="container mt-5 pt-5">
        ...
        <form action="tr_ajouter_course.php" method="post" enctype="multipart/form-data">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="point_depart" placeholder="Ex: Cotonou" required>
            </div>

            <div class="mb-3">
                <label class="form-label fw-bold">Point d'Arrivee</label>
                <input type="text" class="form-control" name="point_darrivee" placeholder="Ex: Porto-Novo" required>
            </div>
            ...
            <div class="mb-3">
                <label class="form-label fw-bold">Image véhicule</label>
                <input type="file" class="form-control" name="image_vehicule" required>
            </div>

            <button type="submit" class="btn btn-primary" name="submit">Ajouter la Course</button>
        </form>
    </div>
